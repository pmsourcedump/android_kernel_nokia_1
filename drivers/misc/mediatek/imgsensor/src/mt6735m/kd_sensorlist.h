...
/*S5K*/
UINT32 S5K5E8_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K5E8JK_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
/*HI*/
UINT32 HI843_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 HI259_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 GC2385JK_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
/*S5K*/
#if defined(S5K5E8_MIPI_RAW)
    {S5K5E8_SENSOR_ID, SENSOR_DRVNAME_S5K5E8_MIPI_RAW, S5K5E8_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E8JK_MIPI_RAW)
    {S5K5E8JK_SENSOR_ID, SENSOR_DRVNAME_S5K5E8JK_MIPI_RAW, S5K5E8JK_MIPI_RAW_SensorInit},
#endif
...
#endif
/*HI*/
#if defined(HI843_MIPI_RAW)
    {HI843_SENSOR_ID, SENSOR_DRVNAME_HI843_MIPI_RAW,HI843_MIPI_RAW_SensorInit},
#endif
    ...
    {HI259MIPI_SENSOR_ID, SENSOR_DRVNAME_HI259_MIPI_RAW, HI259_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(GC2385JK_MIPI_RAW)
    {GC2385JK_SENSOR_ID, SENSOR_DRVNAME_GC2385JK_MIPI_RAW,GC2385JK_MIPI_RAW_SensorInit},
#endif
...
#endif
/*LCA Test*/
#if defined(IMX135_MIPI_RAW_3MP)
    {IMX135_SENSOR_ID, SENSOR_DRVNAME_IMX135_MIPI_RAW_3MP, IMX135_MIPI_RAW_SensorInit},
#endif
